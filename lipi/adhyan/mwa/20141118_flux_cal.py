...
mwa_phase=1
DS_DIR = '/media/rohit/MWA/20141118/pickle/'                   # Path to directory containing DS files
BEAM_DIR = '/media/rohit/MWA/MWA_BEAMS/'             # Path to directory containing beam files
WORKING_DIR = '/media/rohit/MWA/20141118/pickle/'              # Path to working directory
HASLAM_DIR = '/media/rohit/MWA/20141118/haslam/'

DS_LIST=glob.glob('11*.p')
...
star_ra=228.9367175722291
star_dec=-18.35883478122788
#star_ra=252.784
#star_dec=4.992
