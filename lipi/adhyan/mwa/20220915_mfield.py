...
shape = (720*20, 1440*20);carr_data=np.ones(shape)
...
ax0.imshow(hmi_map.data,interpolation=None,vmin=-40,vmax=40,aspect='auto',origin='lower',cmap='jet')
ax1.imshow(carr_map.data,interpolation=None,vmin=-40,vmax=40,aspect='auto',origin='lower',cmap='jet')
plt.show()

plt.imshow(carr_map.data,interpolation=None,vmin=-40,vmax=40,aspect='auto',origin='lower',cmap='jet')
plt.colorbar()
plt.show()
