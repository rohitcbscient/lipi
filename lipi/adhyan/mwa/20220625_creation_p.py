...
#############################################################################################################################################
INDATA_DIR = '/media/rohit/MWA/20220625/ms'                # Path of directory where MS files are sitting
OUTDATA_DIR = '/media/rohit/MWA/20220625/ms'       # Path of directory to which the output DS files are directed
DB_DIR  = '/media/rohit/MWA/20220625/ms'           # Path of directory where database of MWA events is located
WORKING_DIR = '/media/rohit/MWA/20220625/ms'               # Path of working directory
