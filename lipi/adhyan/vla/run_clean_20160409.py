...
###### im.open 
FBAND='L'
MSNAME='sun_L_20160409_18-19UT.12s.cal.ms'
###### im.defineimage 
IMSIZE=256
CELLSIZE='2.0arcsec'
STOKES='LL'
...
#tres=0.05
#total_images=2400
#TIME_LIST=TIME_LIST[0]+np.arange(2400)*tres
tres=1.0
total_images=120
TIME_LIST=TIME_LIST[0]+np.arange(120)*tres
first_time='18:44:00'
i=0
time_list=[0]*(TIME_LIST.shape[0])
time_pair=[0]*(TIME_LIST.shape[0]-1)
...
#phasecenter_='J2000 01h14m43.446s  +7d55m59.701s'
...
for i in range(TIME_LIST.shape[0]):
    ...
    for s in spw_list:
            ...
            imagename[i]='images_1s_LL_256/'+NAME+'.spw.'+sname+'.time.'+time_pair[i]
