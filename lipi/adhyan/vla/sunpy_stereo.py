...
f = hv.download_jp2('2021/03/16 19:00', observatory='STEREO_A',
                    instrument='SECCHI', detector='EUVI', measurement='171',directory='.')
g = hv.download_jp2('2021/03/16 19:00', observatory='SDO',
                    instrument='AIA', measurement='171',directory='.')
cor2 = sunpy.map.Map(f)
euv171 = sunpy.map.Map(g)
cor2.plot()
plt.show()
