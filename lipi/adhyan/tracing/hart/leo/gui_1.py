...
#makes the spinbuttons for the implane coordinates
        ...
        self.implane_label = gtk.Label(r"Image Plane Coordinates in R_sun:")
        ...
        self.table1 = gtk.Table(3, 4, True) # 3 rows x 4 columns
        #self.implane_box_2.add(self.table1)
        #self.implane_box_2.pack_start(self.table1)
        
        # 2nd row of implane coordinates (Y max spinner)
        self.implane_label_yMax = gtk.Label("Y max")
        self.implane_label_yMax.show()
        self.table1.attach(self.implane_label_yMax, 1, 2, 0, 1)
        ...
        self.table1.attach(self.implane_spinner_yMax, 2, 3, 0, 1)        
        
        # 3rd row of implane coordinates (X min spinner and X max spinner)
        self.implane_label_xMin = gtk.Label("X min")
        self.implane_label_xMin.show()
        self.table1.attach(self.implane_label_xMin, 0, 1, 1, 2)
        self.implane_spinner_xMin = gtk.SpinButton(
            gtk.Adjustment(-2,-100,100,.1,1),.1,2)
        self.implane_spinner_xMin.show()
        self.implane_spinner_xMin.connect("value-changed",
                                          self.paramsChange,None)
        self.table1.attach(self.implane_spinner_xMin, 1, 2, 1, 2)
        self.implane_label_xMax = gtk.Label("X max")
        self.implane_label_xMax.show()
        self.table1.attach(self.implane_label_xMax, 2, 3, 1, 2)
        ...
        self.table1.attach(self.implane_spinner_xMax, 3, 4, 1, 2)

        # 4th row of implane coordinates (Y min spinner)
        self.implane_label_yMin = gtk.Label("Y min")
        self.implane_label_yMin.show()
        self.table1.attach(self.implane_label_yMin, 1, 2, 2, 3)
        ...
        self.table1.attach(self.implane_spinner_yMin, 2, 3, 2, 3)
