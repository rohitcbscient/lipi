/*
 * Plasma parameters, density, gradient of density, and magnetic 
 * field calculation.
 * Used for Stokes I and V parameters calculation along the rays.
 * Called by advance_beam_stokesIV.c
 *
 * Created 27 April 2011 by Leonid Benkevitch.
 */
//
...
void plasma_params(int nRay, 
  ...
  // 
  //
  double DeltaS =       Param_I[0];
  double r_chromo =     Param_I[10]; /*  "top" of chromosphere  */
  double r_corona =     Param_I[12]; /*  "bottom" of corona */
  double ProtonMass_g = Param_I[14];

  /* double ElectronMass_g =   Param_I[3]; */
  /* double Rsun_cm =          Param_I[4]; */
  /* double Rsun_km =          Param_I[5];  */
  double RhoSurf =          Param_I[6]; /* = 2.5*3.3452E-16 g/cm^3 */
  /* double h_chromo_km =      Param_I[7]; */
  /* double Te_corona_K =      Param_I[8]; */
  /* double Te_chromo_K =      Param_I[9]; */
  /* double AU_m =             Param_I[10]; */
  /* double AU_Rsun =          Param_I[11]; */
  ...
  for (iRay = 0; iRay < nRay; iRay++) {
    ...
    /* if (1) { // Just Ne in gramms cm^-3 */
      Rho_I[iRay] = Ne*ProtonMass_g;
      GradRho_ID[iRay][0] = Nex*ProtonMass_g;
      GradRho_ID[iRay][1] = Ney*ProtonMass_g;
      GradRho_ID[iRay][2] = Nez*ProtonMass_g;
    /* } */
    /* else if (0) { // Ten times Ne in gramms cm^-3 */
    /*   Rho_I[iRay] = 10.0*Ne*ProtonMass_g; */
    /*   GradRho_ID[iRay][0] = 10.0*Nex*ProtonMass_g; */
    /*   GradRho_ID[iRay][1] = 10.0*Ney*ProtonMass_g; */
    /*   GradRho_ID[iRay][2] = 10.0*Nez*ProtonMass_g; */
    /* } */
    /* else if (0) {  // Ne in cm^-3 */
    /*   Rho_I[iRay] = Ne; */
    /*   GradRho_ID[iRay][0] = Nex; */
    /*   GradRho_ID[iRay][1] = Ney; */
    /*   GradRho_ID[iRay][2] = Nez; */
    /* } */
   
    /*****************************************
     * Sun dipole magnetic field calculation *
     *****************************************/
...
double density_only(int iRay, double Param_I[], 
