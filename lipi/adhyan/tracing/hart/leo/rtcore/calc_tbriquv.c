 ...
 */
  ...
  /* if (thread_num == 0 && err) { */
  /*   fprintf(stderr,"NORMAL V_plasma = %g > 1  !!!\n", V_plasma); */
  /*   fprintf(stderr,"NORMAL v_plasma = %g, 1 - u_plasma = %g\n", */
  /* 	    v_plasma, one_minus_u); */
  /*   fprintf(stderr,"NORMAL Bfield^2 = %g, u_plasma = %g\n", */
  /* 	    Bfield_abs2, u_plasma); */
  /*   fprintf(stderr,"NORMAL Ne = %g, nu_eff = %g\n", Ne, nu_eff); */
  /*   fprintf(stderr,"NORMAL Rho = %g\n", Rho); */
  /*   err = 0; */
  /* } */

  if(V_plasma > 1.){
    fprintf(stderr,"V_plasma = %g > 1  !!!\n", V_plasma);
    fprintf(stderr,"v_plasma = %g, 1 - u_plasma = %g\n", v_plasma, one_minus_u);
    fprintf(stderr,"Bfield^2 = %g, u_plasma = %g\n", Bfield_abs2, u_plasma);
    fprintf(stderr,"Ne = %g, nu_eff = %g\n", Ne, nu_eff);
  ...
  /*
   * Cosine of the angle between Bfield and Dir returned to caller
   */
  *cosbd = costh;
