...
def do_bdsf(imagepath,output_model,freqs,idx_f):
    ...
    img_bdsf = bdsf.process_image(out_imagepath, beam=(10/3600.,10/3600.,0),thresh_pix=5,thresh_isl=6,thresh='hard')
...
for k in range(nk):
	...
	#---------------- Do Point Source Simulation-------------------------
        imagepath='/scratch/snx3000/rsharma/residual1_pybdsf/res_images/res_images_ch'+ii+'_'+"%02d" % k
...
if(plot_test):
	...
	point_img=fits.open('../ska_images/ska_image_ch0'+ch+'_I.fits');point_image=point_img[0].data[0]
