...
MSNAME='20130423T204521-204522.L.50ms.cal.flag.ms'
...
tres=1.0
total_images=5220
TIME_LIST=TIME_LIST[0]+np.arange(5220)*tres
first_time='20:00:00'
i=0
...
for i in range(1):
    ...
    for s in spw_list:
            ...
            imagename[i]='images_LL_flag/'+NAME+'.spw.'+sname+'.time.'+tname
