...
############ TIME
TIME_LIST=TIME_LIST[0]+np.arange(1400)*12
...
j=0#494*3
for i in range(TIME_LIST.shape[0]):
            imagename[i]='images/'+NAME+'.time.'+time_pair[i]
            ...
            if (os.path.isfile(OUTNAME)==False):
                ...
                tclean(vis=MSNAME,selectdata=True,field="",spw=SPW,timerange=time_pair[i], \
                        uvrange="",antenna='',scan="",observation="",intent="",datacolumn="corrected", \
