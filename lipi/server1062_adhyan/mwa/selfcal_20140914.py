...
MOMMS='1094690352_187-188.ms'
os.system('rm -rf 1094690352-187-188.cal.ms')
split(vis=MOMMS,outputvis='1094690352-187-188.cal.ms',datacolumn='data')

########## SELFCAL PROCEDURE BELOW ####################

# INPUT PARAMETERS
MS_='1094690352-187-188.cal.ms'
...
imagename_final='1094690352_img_final' # Name of the final images
chan_final='1~2' # Spectral window selection for final images
timerange_final='' # Time range for final images
antennas_=''#'ea01,ea03,ea06,ea07,ea08,ea09,ea17,ea18,ea21,ea25,ea26,ea27' 
refant_=''# Reference antenna
solar_centre='' # Optional to use
phase_centre='' # From Yingjie script
