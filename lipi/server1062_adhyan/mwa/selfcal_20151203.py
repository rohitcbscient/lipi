...
MOMMS='1133149192-187-188.corrected.ms'
os.system('rm -rf 1133149192-187-188.cal.ms')
split(vis='1133149192-187-188.corrected.ms',outputvis='1133149192-187-188.cal.ms',timerange='03:40:00~03:40:01',datacolumn='data')

########## SELFCAL PROCEDURE BELOW ####################

# INPUT PARAMETERS
MS_='1133149192-187-188.cal.ms'
...
chan_final='7~14' # Spectral window selection for final images
timerange_final='03:40:00~03:40:01' # Time range for final images
...
phase_centre='J2000 16h40m55.277 -19d40m25.38' # From Yingjie script
masks_=[''] # Select a region to mask in the images
initial_model_L_band='f.model' # Provide initial solution, if available.

# STANDARD PARAMETERS 
spw_list=['0'] # List of all the spectral windows required to do selfcal
...
timerange_='03:40:00~03:40:01' # Specify time range for selfcal
...
imsize_=[1024,1024] # Image sizes
cell_=['50arcsec','50arcsec'] # Cell sizes
...
use_initial_model=1 # Optional, if you want to use some initial model
